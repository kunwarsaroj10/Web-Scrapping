...
alphabets = [
    ...
    #'L', 'M', 'N', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z', 'NUM'
    'T'
]
alphabets_pages = [
    #972, 791, 418, 719, 196, 149, 393, 492,203, 471, 770, 
    #315, 1040, 384, 64, 719, 36, 526, 1248, 610, 80, 130, 118, 5, 143, 130, 87
    610
]
            ...
            for xVal in detailsList:
                if yVal in xVal:
                    ...
                    if yVal == 'Shooting Location':
                        ...
                        self.worksheet.write(self.row, self.column + 30, xVal)
